...
I am currently seeking employment in an *analyst* role. My strong background in **mathematics**, **statistics**, and **data science** would lend itself well to the analytical challenges expected of such a position. Moreover, I have approximately two years of “hard” **programming** experience (**C++, Java, SQL**) as well as an additional two+ years of experience with **data analysis/visualization** and **machine learning** in **R**. I also have advanced proficiency with standard industry tools (**Microsoft Excel, Access, VBA**) through completion of the [Technical Skills Course](https://www.theinfiniteactuary.com/skills) offered by the Infinite Actuary and am capable of mastering additional software as needed.
